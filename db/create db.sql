...
create table programacion (
  ...
  , prgm_temperatura boolean not null
  , tprg_id integer null
  , prgm_min integer null
  , prgm_max integer null
	...
	, foreign key (dpst_id) references dispositivo (dpst_id)
	, foreign key (tprg_id) references tipo_rango (tprg_id)
);
