...
INSERT INTO tipo_rango(tprg_nombre) VALUES ('Menor')
INSERT INTO tipo_rango(tprg_nombre) VALUES ('Mayor')
INSERT INTO tipo_rango(tprg_nombre) VALUES ('Entre')
...
alter table propiedad add column prpd_mail2 varchar(5000) null

create table tipo_rango (
	tprg_id integer GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY
	, tprg_nombre varchar(100) not null
);


alter table programacion add column prgm_temperatura boolean null
update programacion set prgm_temperatura = 0
alter table programacion alter column prgm_temperatura set not null

alter table programacion add column tprg_id integer null
alter table programacion add column prgm_min integer null
alter table programacion add column prgm_max integer null
...
ALTER TABLE programacion ADD CONSTRAINT x FOREIGN KEY (tprg_id) REFERENCES tipo_rango (tprg_id)
 */