...
<head>
    ...
    <script type="text/javascript" src="/plcbus/js/backoffice/graphics.js"></script>
        ...
        <div class="page-region">
            <div class="page-region-content">
                <div class="page-control" data-role="page-control">
                    <div class="span10">
                        <h2>Consumo</h2>
                        <div id="consumerGraphic" style="height: 400px; min-width: 310px; max-width: 800px; margin: 0 auto"></div>
                    </div>

                    <div class="span10">
                        <h2>Eventos por dispositivo</h2>
                        <div id="eventsGraphic" style="height: 400px; min-width: 310px; max-width: 800px; margin: 0 auto"></div>
                    </div>

                    <div class="span10">
                        <h2>Sensores</h2>
                        <div id="sensorGraphic" style="height: 400px; min-width: 310px; max-width: 800px; margin: 0 auto"></div>
                    </div>
                    <div class="span10">
                        <div id="sensor2Graphic" style="height: 400px; min-width: 310px; max-width: 800px; margin: 0 auto"></div>
                    </div>
