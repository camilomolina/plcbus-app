...
<head>
    ...
    <script type="text/javascript" src="/plcbus/js/highcharts/highcharts.js"></script>
    <script type="text/javascript" src="/plcbus/js/highcharts/highcharts-more.js"></script>
    <script type="text/javascript" src="/plcbus/js/highcharts/modules/solid-gauge.js"></script>
    <script type="text/javascript" src="/plcbus/js/highcharts/modules/exporting.js"></script>
    ...
    <script type="text/javascript" src="/plcbus/js/backoffice/statistics.js"></script>
        ...
        <div class="page-region">
            <div class="page-region-content">
                <div class="page-control" data-role="page-control">
                    ...
                    <div class="grid">
                        <div class="row">
                            <div class="span5 bg-color-greenDark" onclick="Statistics.toReport();" style="cursor: pointer;">
                                <img src="/plcbus/images/metro/simple.png" class="place-right" style="margin: 10px;"/>
                                <h2 class="fg-color-white">&nbsp;Reportes</h2>
                            </div>

                            <div class="span5 bg-color-greenLight" onclick="Statistics.toGraphics();" style="cursor: pointer;">
                                <img src="/plcbus/images/metro/grid.png" class="place-right" style="margin: 10px;"/>
                                <h2 class="fg-color-white">&nbsp;Graficos</h2>
                            </div>
                    ...
                    <div class="grid">
                        <div class="row">
                            <div class="span5">
                                <div id="consumptionGraphic" style="height: 200px; width: 300px; float: left" ></div>
                            </div>
                            <div class="span5">
                                <fieldset>
                                    ...
                                    <p class="tertiary-info-secondary-text">
                                        El calculo del consumo se realiza en base al consumo promedio de 88 Pesos por kWh.
                                        El calculo considera un calculo lineal sin tomar en considerar los distintos watts de
                                        cada ampolleta, tomando un generico de 75Watt.
                                    </p>

                                </fieldset>

                                <!--min-width: 260px; max-width: 600px; -->
                                <!--<div id="sensorGraphic" style="height: 200px;  width: 300px; margin: 0 auto"></div>-->
                            </div>
                        </div>
                    </div>
